function FlippingBook() {
	...
	this.settings = {
			...
			//backgroundImage: "/assets/pageflip/img/bookBackground.png",
...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/assets/vendor/pageflip/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/assets/vendor/pageflip/js/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:   this.settings.backgroundColor });
}
