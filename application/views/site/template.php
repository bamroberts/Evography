...
<!--[if (gte IE 9)|!(IE)]><!--> <html class="no-js" lang="en" xmlns="http://www.w3.org/1999/xhtml"> <!--<![endif]-->
  <head>
    ...
    .top .wrapper {text-align: right;padding-right:40px;}
      ...
      .package .link {background-color: #f8f8f8; text-align: center;}
     .trial {margin-top:20px;clear:both; font-size: 2em; padding:0.5em 1em; margin-bottom:1em; background-color: #008BFD; -moz-border-radius: 5px;color:white; border:1px solid white;}
     .trial small {display:block; font-size: 0.5em; line-height: 1.5em;}
     .trial a {float:right;
    left: 20px;
    position: relative;
    top: -10px;
    ...
    #pricing .features li {font-size:20px; line-height:140%;}
    #pricing .features li small {font-size:60%;line-height:140%; display:block;}
    #pricing .btn {margin:10px 0;}
    .primary, .btn.primary {color:white;}
   ...
   button:hover, a.button:hover {box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5); background-color: #7AC3FF;}
	 ...
	 button,	a.button {
      ...
      text-shadow:0 0 2px rgba(0, 0, 0, 0.5), 0 0 7px #008BFD;
		...
		header nav li a:hover,header nav li.active a {box-shadow: 0px 0px 10px #008BFD, 0 0 5px black inset;  color:white; text-decoration:none;}
		
		header nav li.active a {background:url("/assets/images/ui/button_alpha.png") repeat-x scroll center center #008BFD;box-shadow: 0px 0px 10px #008BFD, 0 0 2px white inset;}
...
.more-link::after {
  content: " \00BB"; }
		...
		legend {font-size:18px; line-height:20px;}
  h3 {font-size:22px;}
  strong, legend {color:#008BFD;}
...
fieldset.horizontal .group {float:left; margin-right:20px; padding-right:10px;}		
  ...
  <body id="<?php echo url::page_id(); ?>" class="<?php echo url::page_class(); ?>">
    <header>
      <div class="wrapper">
        <div id="logo" style="">
          EVOGRAPHY
        ...
        <nav>
          <?php echo View::factory('site/blocks/menu'); ?>
        </nav>
